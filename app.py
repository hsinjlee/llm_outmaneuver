"""
Entry point for the Outmaneuver Arena LLM Battle
...
st.set_page_config(
    layout="wide",
    page_title="Outmaneuver",
    menu_items={
        "About": "outmaneuver is an LLM arena that pits LLMs against each other in a battle of negotiation."
    },
    page_icon="🧠",

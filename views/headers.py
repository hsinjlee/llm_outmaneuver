...
def display_image() -> None:
    ...
    """
    with open("outmaneuver_image_base64.txt", "r") as f:
        base64_string = f.read()
    image_data = base64.b64decode(base64_string)
    st.image(BytesIO(image_data), use_container_width="auto")

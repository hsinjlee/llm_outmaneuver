...
def display_coffee():
    st.markdown(
        "<span style='font-size:13px;'>If you enjoyed Outmaneuver, I'm super grateful for any recognition, but not required at all!</span>",
        unsafe_allow_html=True,
    )
    st.markdown(
        """
...
def display_sidebar():
    with st.sidebar:
        st.markdown("### Outmaneuver Leaderboard")
